      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-[#141414] rounded-sm border border-[#2d2d2d] p-8 md:p-10 shadow-[0_25px_80px_rgba(0,0,0,0.4)]">
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-[#1a1a1a] border border-[#3d3d3d] text-white focus:border-[#c9a227] focus:ring-1 focus:ring-[#c9a227] outline-none"
                />
              </div>
              <div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-400 mb-3">Preference</label>
              <div className="flex gap-4">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="radio"
                    name="preference"
                    checked={preference === "rooftop"}
                    onChange={() => setPreference("rooftop")}
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="radio"
                    name="preference"
                    checked={preference === "fine-dine"}
                    onChange={() => setPreference("fine-dine")}
                    className="accent-[#c9a227]"
                  />
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              <input
                type="checkbox"
                checked={celebrationCake}
                onChange={(e) => setCelebrationCake(e.target.checked)}
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-[#1a1a1a] border border-[#3d3d3d] text-white placeholder-gray-500 focus:border-[#c9a227] focus:ring-1 focus:ring-[#c9a227] outline-none"
                />
              </div>
              <div>
